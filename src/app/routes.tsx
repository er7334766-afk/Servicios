...
const HomeRouter = lazy(() => import('./components/screens/HomeRouter'));
const SearchScreen = lazy(() => import('./components/screens/SearchScreen'));
const WorkerProfileScreen = lazy(() => import('./components/screens/WorkerProfileScreen'));
const ProfileRouter = lazy(() => import('./components/screens/ProfileRouter'));
const ChatListScreen = lazy(() => import('./components/screens/ChatListScreen'));
const ChatScreen = lazy(() => import('./components/screens/ChatScreen'));
const AgendaScreen = lazy(() => import('./components/screens/AgendaScreen'));
...
export const router = createBrowserRouter([
  {
    path: '/',
    element: <S><LandingScreen /></S>,
  },
  {
    path: '/auth',
    element: <S><AuthScreen /></S>,
  },
  {
    path: '/home',
    Component: MobileShell,
    children: [
      { index: true, element: <S><HomeRouter /></S> },
      { path: 'search', element: <S><SearchScreen /></S> },
      { path: 'worker/:id', element: <S><WorkerProfileScreen /></S> },
      { path: 'profile', element: <S><ProfileRouter /></S> },
      { path: 'chat', element: <S><ChatListScreen /></S> },
      { path: 'chat/:id', element: <S><ChatScreen /></S> },
